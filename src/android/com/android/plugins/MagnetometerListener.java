...
public class MagnetometerListener extends CordovaPlugin implements SensorEventListener {
    ...
    private Runnable mainRunnable = new Runnable() {
        public void run() {
            MagnetometerListener.this.timeout();
        }
    };

    /**
     * Create an magnetometer listener.
     */
    ...
    /**
     * Called by magnetometer when listener is to be shut down.
     * Stop listener.
     */
    ...
    */
    private int start() {
        ...
        if ((list != null) && (list.size() > 0)) {
          ...
          this.fail(MagnetometerListener.ERROR_FAILED_TO_START, "No sensors found to register magnetometer listening to.");
          return this.status;
        }
    ...
    /**
     * Stop listening to magnetometer sensor.
     */
    private void stop() {
        stopTimeout();
    ...
    private void timeout() {
        if (this.status == MagnetometerListener.STARTING) {
            this.setStatus(MagnetometerListener.ERROR_FAILED_TO_START);
            this.fail(MagnetometerListener.ERROR_FAILED_TO_START, "Magnetometer could not be started.");
        }
    }
